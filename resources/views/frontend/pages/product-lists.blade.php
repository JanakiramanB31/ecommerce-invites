						...
						<div class="single-product">
							<div class="product-img">
								<a href="{{route('product-detail',$product->slug)}}">
									...
									$photo=explode(',',$product->photo);
									@endphp
									<img class="default-img" src="{{$photo[0]}}" width="100" height="100" style="height: 150px;" alt="{{$photo[0]}}">
									<img class="hover-img" src="{{$photo[0]}}" style="height: 150px;" alt="{{$photo[0]}}">
								</a>
					...
					<div>
						<div class="list-content">
							<div class="product-content">
								<h6><a href="{{route('product-detail',$product->slug)}}"><b>{{$product->title}}</b></a></h6>
								<div class="d-flex product-price mt-1" style="gap: 10px;">
									@php
									$after_discount=($product->price-($product->price*$product->discount)/100);
									@endphp
									<span>${{number_format($after_discount,2)}}</span>
									<del>${{number_format($product->price,2)}}</del>
									<b>{{number_format($product->discount)}}% OFF</b>
								</div>

								{{-- <p>{!! html_entity_decode($product->summary) !!}</p> --}}
							</div>
							<!-- <p class="des pt-2">{!! html_entity_decode($product->summary) !!}</p> -->
							<p class="des pt-2">{{ Str::limit(strip_tags(html_entity_decode($product->summary)), 100) }}
						...
						<div class="product-gallery">
							<div class="quickview-slider-active">
								...
								<div class="single-slider">
									<img src="{{$data}}" width="100" height="100" style="height: 100px;" alt="{{$data}}">
								</div>
								@endforeach
							</div>
						</div>
