...
@endsection
@section('title', config('app.name', 'SHOPPING') . ' || Product Details')
												...
												<ul class="slides">
													...
													@foreach($photo as $index =>  $data)
														<li data-thumb="{{$data}}"  rel="adjustX:10, adjustY:">
															<img src="{{$data}}" style="height:400px;object-fit:contain" alt="{{$data}}"
																class="zoomImage"
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
												...
												<table class="mt-3" border="1" style="border-collapse: collapse;">
													<tbody>
														<!-- <tr>
														...
														<tr>
															...
															<td style="padding:10px;">
																<p>{{$product_detail->sub_cat_info['title']}}</p>
															</td>
														</tr>
														@endif -->
														<tr>
														...
														<tr>
															<td style="padding:10px;">
																<b>Dimensions in Centimeter</b>
																
															</td>
															<td style="padding:10px;">Width 0 , Height 0</td>
														</tr>
														<tr>
															<td style="padding:10px;">
																<b>Shipping Weight </b>
															...
															<td style="padding:10px;">0 (in grams)</td>
														</tr>
														<tr>
															<td style="padding:10px;">
																<strong>Delivery Time:</strong>
															</td>
															<td style="padding:10px;">01 - 10 Days</td>
														</tr>
													</tbody>
												</table>
												<p>**Additional time is needed for overseas shipments</p>
												<p class="description">{!!($product_detail->summary)!!}</p>
												<a href="#" data-facnybox-type="ajax">
													<button type="button" title="Get Quote" class="button view_page_enquiry" style="padding: 10px;margin-top:10px;background: #ffc107;color:white;">
														<i class="fa fa-envelope" style="margin-right: 5px;"></i> <span>Get Quote</span> 
													</button>
												</a>
														...
														<div class="row">
															<div class="col-12">
																<div class="single-des">
																	<!-- <p>{!! html_entity_decode($product_detail->description) !!}</p> -->
																</div>
															</div>
														</div>
													</div>
